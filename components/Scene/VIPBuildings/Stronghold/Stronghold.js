...
import SKBannerA from '/models/SKBannerA'
import SKBannerB from '/models/SKBannerB'
const Stronghold = () => {
    return (
        <Suspense fallback={null}>
            <group position = {[60.15,14,200]} rotation={[0, Math.PI/360*-176, 0]} scale = {[0.9,0.9,0.9]}>
                ...
                <SKBannerA position={[-8.5,0,-7]} rotation={[0,Math.PI/2*-1,0]}></SKBannerA>
                <SKBannerB position={[-8.5,0,2]} rotation={[0,Math.PI/2*-1,0]}></SKBannerB>
                </group>
